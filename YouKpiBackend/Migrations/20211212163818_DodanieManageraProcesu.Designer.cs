...
namespace YouKpiBackend.Migrations
{
    ...
    [Migration("20211212163818_DodanieManageraProcesu")]
    partial class DodanieManageraProcesu
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YouKpiBackend.ModelsEntity.CompetencesLevels", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("YouKpiBackend.ModelsEntity.MediumsDictionary", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("YouKpiBackend.ModelsEntity.Process", b =>
                {
                    ...
                    b.Property<int?>("ProcessManagerId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("YouKpiBackend.ModelsEntity.ProcessArea", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("ProcessArea");
                });

            modelBuilder.Entity("YouKpiBackend.ModelsEntity.ProcessCompetences", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("ProcessCompetences");
                });

            modelBuilder.Entity("YouKpiBackend.ModelsEntity.ProcessSubject", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("YouKpiBackend.ModelsEntity.ProcessesProcessAreas", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("ProcessesProcessAreas");
                });

            modelBuilder.Entity("YouKpiBackend.ModelsEntity.ProcessesProcessSubjects", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("ProcessSubjectId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ProcessSubjectId");

                    b.ToTable("ProcessesProcessSubjects");
                });
            ...
            modelBuilder.Entity("YouKpiBackend.ModelsEntity.Process", b =>
                {
                    b.HasOne("YouKpiBackend.ModelsEntity.Pracownik", "ProcessManager")
                        .WithMany("ManagerOfProcesses")
            ...
            modelBuilder.Entity("YouKpiBackend.ModelsEntity.ProcessCompetences", b =>
                {
                    b.HasOne("YouKpiBackend.ModelsEntity.CompetencesLevels", "CompetenceLevel")
                        .WithMany("ProcessCompetences")
            ...
            modelBuilder.Entity("YouKpiBackend.ModelsEntity.ProcessesProcessAreas", b =>
                {
                    b.HasOne("YouKpiBackend.ModelsEntity.ProcessArea", "ProcessArea")
                        .WithMany()
            ...
            modelBuilder.Entity("YouKpiBackend.ModelsEntity.ProcessesProcessSubjects", b =>
                {
                    b.HasOne("YouKpiBackend.ModelsEntity.Process", "Process")
                        .WithMany("ProcessSubjects")
                        .HasForeignKey("ProcessId")
                        .HasConstraintName("FK_ProcessesProcessSubjects");

                    b.HasOne("YouKpiBackend.ModelsEntity.ProcessSubject", "ProcessSubject")
                        .WithMany()
                        .HasForeignKey("ProcessSubjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Process");

                    b.Navigation("ProcessSubject");
                });
            ...
            modelBuilder.Entity("YouKpiBackend.ModelsEntity.CompetencesLevels", b =>
                {
                    b.Navigation("ProcessCompetences");
                });
            ...
            modelBuilder.Entity("YouKpiBackend.ModelsEntity.Pracownik", b =>
                {
                    b.Navigation("ManagerOfProcesses");
