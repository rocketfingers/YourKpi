...
namespace YouKpiBackend.BusinessLibrary.Offer
{
    public class OfferPdfService
    {
       ...
       // private readonly int x = 15;
        ...
        {
            var actualRow = NewLine(ref height, 0, tableLineHeight);
            gfx.DrawString(ol.Product.ProductId.ToString(), regularFont, XBrushes.Black, new XRect(NewColumn(actualRow, col1Pos), new XSize(col2Pos - col1Pos, tableLineHeight)), XStringFormats.TopLeft);
